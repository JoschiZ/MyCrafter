...
<svelte:head>
	<title>MyCrafter.io! Login with your Battlenet Account</title>
</svelte:head>
...
<style>
	* :global(.login-button) {
		...
		--width: 150px;
		width: var(--width);
		height: calc(var(--width) * 0.548);

		font-size: xxx-large;
	}

	* :global(.login-button + .login-button) {
		border-left: 1px solid rgba(245, 245, 245, 0.212);
	}
